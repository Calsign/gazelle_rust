...
_NORMAL_DEPENDENCIES = {
    "": {
        _COMMON_CONDITION: {
            "cargo-lock": Label("@crates_vendor__cargo-lock-8.0.2//:cargo_lock"),
            "cargo_toml": Label("@crates_vendor__cargo_toml-0.16.3//:cargo_toml"),
            "clap": Label("@crates_vendor__clap-4.4.18//:clap"),
            "lazy_static": Label("@crates_vendor__lazy_static-1.4.0//:lazy_static"),
            "syn": Label("@crates_vendor__syn-2.0.43//:syn"),
        },
    },
}
...
def crate_repositories():
    ...
    maybe(
        ...
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/anstream/0.6.11/download"],
        strip_prefix = "anstream-0.6.11",
        build_file = Label("@//3rdparty/crates:BUILD.anstream-0.6.11.bazel"),
    )
    ...
    maybe(
        ...
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/anstyle/1.0.5/download"],
        strip_prefix = "anstyle-1.0.5",
        build_file = Label("@//3rdparty/crates:BUILD.anstyle-1.0.5.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@//3rdparty/crates:BUILD.anstyle-parse-0.2.3.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@//3rdparty/crates:BUILD.anstyle-query-1.0.2.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@//3rdparty/crates:BUILD.anstyle-wincon-3.0.2.bazel"),
    )
    ...
    maybe(
        ...
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/cargo-lock/8.0.2/download"],
        strip_prefix = "cargo-lock-8.0.2",
        build_file = Label("@//3rdparty/crates:BUILD.cargo-lock-8.0.2.bazel"),
    )
    ...
    maybe(
        ...
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/cargo_toml/0.16.3/download"],
        strip_prefix = "cargo_toml-0.16.3",
        build_file = Label("@//3rdparty/crates:BUILD.cargo_toml-0.16.3.bazel"),
    )
    ...
    maybe(
        ...
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/clap/4.4.18/download"],
        strip_prefix = "clap-4.4.18",
        build_file = Label("@//3rdparty/crates:BUILD.clap-4.4.18.bazel"),
    )
    ...
    maybe(
        ...
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/clap_builder/4.4.18/download"],
        strip_prefix = "clap_builder-4.4.18",
        build_file = Label("@//3rdparty/crates:BUILD.clap_builder-4.4.18.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@//3rdparty/crates:BUILD.clap_derive-4.4.7.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@//3rdparty/crates:BUILD.clap_lex-0.6.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@//3rdparty/crates:BUILD.colorchoice-1.0.0.bazel"),
    )
    ...
    maybe(
        ...
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/hashbrown/0.14.1/download"],
        strip_prefix = "hashbrown-0.14.1",
        build_file = Label("@//3rdparty/crates:BUILD.hashbrown-0.14.1.bazel"),
    )
    ...
    maybe(
        ...
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/indexmap/2.0.2/download"],
        strip_prefix = "indexmap-2.0.2",
        build_file = Label("@//3rdparty/crates:BUILD.indexmap-2.0.2.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@//3rdparty/crates:BUILD.memchr-2.6.4.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@//3rdparty/crates:BUILD.proc-macro2-1.0.69.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@//3rdparty/crates:BUILD.quote-1.0.33.bazel"),
    )
    ...
    maybe(
        ...
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/semver/1.0.13/download"],
        strip_prefix = "semver-1.0.13",
        build_file = Label("@//3rdparty/crates:BUILD.semver-1.0.13.bazel"),
    )
    ...
    maybe(
        ...
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/serde/1.0.156/download"],
        strip_prefix = "serde-1.0.156",
        build_file = Label("@//3rdparty/crates:BUILD.serde-1.0.156.bazel"),
    )
    ...
    maybe(
        ...
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/serde_derive/1.0.156/download"],
        strip_prefix = "serde_derive-1.0.156",
        build_file = Label("@//3rdparty/crates:BUILD.serde_derive-1.0.156.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@//3rdparty/crates:BUILD.serde_spanned-0.6.3.bazel"),
    )
    ...
    maybe(
        ...
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/syn/2.0.43/download"],
        strip_prefix = "syn-2.0.43",
        build_file = Label("@//3rdparty/crates:BUILD.syn-2.0.43.bazel"),
    )
    ...
    maybe(
        ...
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/toml/0.5.9/download"],
        strip_prefix = "toml-0.5.9",
        build_file = Label("@//3rdparty/crates:BUILD.toml-0.5.9.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@//3rdparty/crates:BUILD.toml-0.8.2.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@//3rdparty/crates:BUILD.toml_datetime-0.6.3.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@//3rdparty/crates:BUILD.toml_edit-0.20.2.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@//3rdparty/crates:BUILD.unicode-bidi-0.3.8.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@//3rdparty/crates:BUILD.unicode-ident-1.0.3.bazel"),
    )
    ...
    maybe(
        ...
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/unicode-normalization/0.1.21/download"],
        strip_prefix = "unicode-normalization-0.1.21",
        build_file = Label("@//3rdparty/crates:BUILD.unicode-normalization-0.1.21.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@//3rdparty/crates:BUILD.utf8parse-0.2.1.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@//3rdparty/crates:BUILD.windows-targets-0.52.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@//3rdparty/crates:BUILD.windows_aarch64_gnullvm-0.52.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@//3rdparty/crates:BUILD.windows_aarch64_msvc-0.52.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@//3rdparty/crates:BUILD.windows_i686_gnu-0.52.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@//3rdparty/crates:BUILD.windows_i686_msvc-0.52.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@//3rdparty/crates:BUILD.windows_x86_64_gnu-0.52.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@//3rdparty/crates:BUILD.windows_x86_64_gnullvm-0.52.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@//3rdparty/crates:BUILD.windows_x86_64_msvc-0.52.0.bazel"),
    )
    ...
    maybe(
        ...
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/winnow/0.5.17/download"],
        strip_prefix = "winnow-0.5.17",
        build_file = Label("@//3rdparty/crates:BUILD.winnow-0.5.17.bazel"),
    )
